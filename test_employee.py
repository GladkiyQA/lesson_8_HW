...
def test_create_new_employee():
    # создаем компанию
    # создаем сотрудника
    # запрашиваем сотрудника из бд
    # сравниваем ответ из бд и ответ из json
...
def test_get_employee_by_id():
    # Создаем компанию
    # Создаем сотрудника
    # Запрашиваем сотрудника из бд по айди
    # Запрашиваем сотрудника через апи по айди
    # Сраниваем ответы, поля
...
def test_edit_employee():
    ...
    # Редактируем сотрдуника через бд
    # Запрашиваем сотрудника из бд по айди
    # Запрашиваем сотрудника через апи по айди
    # Сраниваем ответы, поля
